...

{
    ...
    {
        return view('master_setup.subject_setup.course_subjects', ['page_title' => 'Course Subject Setup']);
    }
    ...
    function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            DB::beginTransaction();
            $subject = new Subject();
            $subject->institute_id = $instituteId;
    ...
    public function edit(Request $request)
    {
        ...
        $details = Subject::where(['id' => $id])->select('institute_id', 'code', 'id', 'name', 'record_status')->first();
        if ($details) {
            $output = [
                'status' => true,
                'data' => $details
