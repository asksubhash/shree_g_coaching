    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 offset-md-4 offset-sm-3 col-sm-6 col-12 shadow-sm p-3">
                <form action="javascript:void(0)" class="form-style2" id="studyCenterLogin">
                    @csrf
                    <div class="form-inner">
                        <h3 class="form-title h5 mb-3 text-center fw-bold">Study Center Login</h3>
                        <div class="">
                            <div class="form-floating mb-3">
                                <input type="email" class="form-control rounded-3" id="username" placeholder="Username" name="email_id">
...
<script>
    $("#studyCenterLogin").validate({
        ...
        submitHandler: function(form, event) {
            ...
            var formData = new FormData(document.getElementById('studyCenterLogin'))
            $(".loader").show();
            $.ajax({
