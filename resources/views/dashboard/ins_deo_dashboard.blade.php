...
<div class="page-content">
    ...
    <!-- Main content -->
    @if (in_array(env('CENTER_INSTITUTE_ID'), $instituteIdsMapped))
    @if (count($stApplications) > 0)
    <div class="alert border-0 border-start border-5 rounded-0 shadow-sm border-primary bg-white">
        <div>
            <img src="{{ asset('website_assets/images/new.gif') }}" alt="Image" style="height: 40px; object-fit: contain;">
            New applications recevied from student:
            <a href="{{ url('study-center/student/new-applications') }}" class="btn btn-outline-danger btn-sm">
