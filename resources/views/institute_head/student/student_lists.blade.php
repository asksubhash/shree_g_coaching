                    ...
                    <div class="tab-content py-3">
                        <div class="tab-pane fade active show" id="dangerNew" role="tabpanel">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped w-100 nowrap" id="dataTableStudentList">
                                    <thead>
                                        <tr>
...
<script>
    var dataTableStudentList = $('#dataTableStudentList').DataTable({
        processing: true,
        serverSide: true,
        autoWidth: false,
        scrollX: false,
        ...
        ordering: false,
        "ajax": {
            url: base_url + "/ajax/students/fetch-all-students",
            type: 'POST',
            data: function(d) {
