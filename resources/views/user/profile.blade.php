                        ...
                        <div class="card card-custom card-outline">
                            <div class="card-body box-profile">
                                <div class="text-center">
                                    <img class="profile-user-img w-50 rounded mb-3" src="{{ asset('dist/img/avatar4.png') }}" alt="User profile picture">
                                </div>

                                <h3 class="profile-username text-center fs-5 mb-1">
                                    {{ ucwords(auth()->user()->userDetail->f_name . '' . auth()->user()->userDetail->l_name) }}
                                </h3>
                                ...
                                <hr>
                                <div class="text-center">
                                    <button type="button" id="change_password_btn" class="btn btn-primary btn-sm"><i class="bx bx-edit"></i> Change
                                        Password</button>
                                </div>
                            </div>
                            <!-- /.card-body -->
                            ...
                            <div class="card-body">
                                <form class="row g-3" class="updateProfileForm" id="updateProfileForm" autocomplete="off">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-primary btn-sm" id="profileFormSubmitBtn"><span class="bx bx-save"></span>
...
<script>
    ...
    $('#changePasswordForm').on('submit', function(event) {
        ...
        // Send Ajax Request
        $.ajax({
            url: base_url + '/ajax/profile/change-password',
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    $("#updateProfileForm").validate({
        ...
        submitHandler: function(form, event) {
            ...
            // Send Ajax Request
            $.ajax({
                url: base_url + '/ajax/profile/update',
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
