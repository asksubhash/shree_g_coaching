                    ...
                    <form action="" class="add_user_form" id="add_user_form">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label" for="name">First Name<strong
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label" for="l_name">Last Name<strong
                                            class="text-danger">*</strong></label>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label" for="email_id">Email ID<strong
                                            class="text-danger">*</strong></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label" for="role">Role<strong
                                            class="text-danger">*</strong></label>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label" for="status">Deparment</label>
    ...
    <script>
        var userDataTable = $('#user-datatable').DataTable({
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    className: "text-center",
                    render: function(data, type, row, meta) {
                        return (data.department_name) ? data.department_name : data.department_id;
                    }
        ...
        $(window).on('load', function() {
            $('.dataTables_wrapper .dt-buttons').append(
                '<button class="btn btn-custom" id="add_user_btn"><i class="fas fa-plus"></i> Add New</button>');
        })
        ...
        $(document).on('click', '#add_user_btn', function() {
            ...
            $('#userModalLabel').html('<i class="fas fa-plus"></i> Add New User');
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == true) {
                        ...
                        $('#department option[value="' + data.department_id + '"]').prop('selected',
                            true);
