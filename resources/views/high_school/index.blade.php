...
<script>
    var studentDetailsDatatable = $('#studentDetailsDatatable').DataTable({
        ...
        "ajax": {
            url: base_url + "/high-school/fetch-all",
            type: 'POST',
            data: function(d) {
    ...
    $(window).on('load', function() {
        $('#studentDetailsDatatable_wrapper .dt-buttons').append(
            `<a href="{{ url('high-school/add') }}" class="btn btn-danger btn-sm"><i class="bx bx-plus"></i> Add New Student</a>`
        );
    })
    ...
    $(document).on('click', '.deleteUserBtn', function() {
        ...
        if (id) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: base_url + '/high-school/delete',
                        type: 'POST',
                        data: {
                            id: id,
